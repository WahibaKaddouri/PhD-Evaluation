...
<div id="page-wrapper" style="width: 90%;height:1500px;">
    ...
    <div class="page-contentbar">
        ...
        <!-- START PAGE CONTENT -->
        <div id="page-right-content" style="border:none; margin-left:0px;height:1500px;">
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="width:80%;margin-left:100px;">
                                ...
                                <div class="row" style="padding:10px;">
                                    ...
                                    <br/>
                                    <button id="" class="btn-success btn-rounded" style="background-color:#008e8e;"> <a href="/Enseignant/Fichiers_pedagogiques/${ensId}"><h5 style="color:white;"> Voir les documents pédagogiques importés</h5></a></button>
                                </div>
                            </div>
