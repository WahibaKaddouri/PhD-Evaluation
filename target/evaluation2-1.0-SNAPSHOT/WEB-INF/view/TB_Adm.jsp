                    ...
                    <div class="row" >
                        ...
                        <div class="col-lg-3 col-sm-6" style="width: 250px;">
                            <div class="widget-inline-box text-center">
                                <span class="label label-danger">Nombre d'enseignants inscrits</span> <br>
                        ...
                        <div class="col-lg-3 col-sm-6" style="width: 250px;">
                            <div class="widget-inline-box text-center">
                                <span class="label label-warning">Nombre de dossiers évalués</span>
                                <h3 class="m-t-10"> <b data-plugin="counterup">${nb_evaluation}</b></h3>
                                <p class="text-muted"> Dossiers  </p>
                            </div>
                        </div>

                        <div class="col-lg-3 col-sm-6" style="width: 250px;">
                            <div class="widget-inline-box text-center">
                                <span class="label label-info">Nombre de dossiers en attente</span>
                                <h3 class="m-t-10"> <b data-plugin="counterup">${nb_attente}</b></h3>
                                <p class="text-muted">Dossiers</p>
                            </div>
                        </div>
