                    ...
                    <div class="tab-content" style="height:100%">
                        <div class="row">
                            <div class="col-sm-12" style="width:80%;margin-left:100px;">
                                <h3 class="m-b-20 header-title" style="color: #26C4EC">Documents administratifs</h3>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover mails m-0 table table-actions-bar">
                                                ...
                                                <c:forEach var="file" items="${fichiers}">
                                                    <tr style="border:none;border-bottom:grey;">
                                                       <td><a href="/resources/files/Administratifs/${idEns}/${file}"><c:out value="${file}"></c:out></a>
                                                       </td>
                                                    </tr>
