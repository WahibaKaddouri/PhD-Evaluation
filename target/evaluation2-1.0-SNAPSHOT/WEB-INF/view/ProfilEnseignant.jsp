                    ...
                    <div class="tab-content" style="height:100%">
                        <div class="row">
                            <div class="col-sm-12" style="width:80%;margin-left:100px;">
                                <h3 class="m-b-20 header-title" style="color: #067790; text-align: center;">Infomations personnelles</h3>
                                ...
                                <div class="row" style="padding: 10px;">
                                    ...
                                    <div class="col-md-6" style="margin-left:250px; ">
                                        ...
                                        <div class="panel panel-default panel-fill">
                                            ...
                                            <div class="panel-body" style="padding:50px;">
                                                <div class="m-b-20">
                                                    ...
                                                    <input class="form-control" class="text" value="${enseign.nom}" style="width:100%"/>
                                                </div>

                                                <div class="m-b-20">
                                                    <strong>Prénom</strong>

                                                    <input class="form-control" class="text" value="${enseign.prenom}" style="width:100%"/>
                                                </div>

                                                <div class="m-b-20">
                                                    <strong>Numero de télephone</strong>

                                                    <input class="form-control" class="text" value="${enseign.num_tel}" style="width:100%"/>
                                                </div>

                                                <div class="about-info-p m-b-0">
                                                    <strong>Etablissement</strong>

                                                    <input class="form-control" class="text" value="${enseign.id_etablissement}" style="width:100%"/>
                                                </div>

                                                <div class="about-info-p m-b-0">
                                                    <strong>Date d'installation dans le grade</strong>

                                                    <input class="form-control" class="text" value="${enseign.date_installation_grade}" style="width:100%"/>
                                                </div>


                                                <div class="about-info-p m-b-0">
                                                    <strong>Spécialité</strong>
                                                    <input class="form-control" type="text" value="${enseign.id_section}" style="width:100%"/>
                                                </div>
                                        ...
                                        <button style="width:99%" type="button" class="fc-month-button fc-button fc-state-default fc-corner-left fc-state-active">modifier</button>
                                    </div>
