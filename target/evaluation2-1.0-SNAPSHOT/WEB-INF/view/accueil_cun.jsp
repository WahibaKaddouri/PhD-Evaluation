                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="highlight-block xs-margin margin-bottom-20">
                            <div class="highlight-block-inner height350">
                                ...
                                <p>Si votre spécialité fait partie du domaine de la technologie.</p><br>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="highlight-block xs-margin margin-bottom-20">
                            <div class="highlight-block-inner height350">
                                ...
                                <p>Si votre spécialité fait partie des sciences exactes (Maths, Physique ...)</p>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="highlight-block xs-margin margin-bottom-20">
                            <div class="highlight-block-inner height350">
                                ...
                                <p>Si votre spécialité fait des sciences de la narure et de la vie (biologie, sciences alimentaires ...)</p><br>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="highlight-block xs-margin margin-bottom-20">
                            <div class="highlight-block-inner height350">
                                ...
                                <p>Si votre spécialité fait partie des sciences économiques (gestion, commerce ...)</p><br>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="highlight-block xs-margin margin-bottom-20">
                            <div class="highlight-block-inner height350">
                                ...
                                <p>Si votre spécialité fait partie des sciences humaines et sociales.</p><br>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="highlight-block xs-margin margin-bottom-20">
                            <div class="highlight-block-inner height350">
                                ...
                                <p>Si votre spécialité fait partie des langues et littérature.</p><br>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="highlight-block xs-margin">
                            <div class="highlight-block-inner height350">
                                ...
                                <p>Si votre spécialité fait partie du droit et administration</p><br>
