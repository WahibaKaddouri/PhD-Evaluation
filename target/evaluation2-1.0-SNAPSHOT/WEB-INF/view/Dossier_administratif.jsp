                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form:form method="POST" modelAttribute="fileBucket" action="${pageContext.request.contextPath}/Enseignant/dossiers/Dossier_administratif/Demande" enctype="multipart/form-data" class="form-horizontal">
