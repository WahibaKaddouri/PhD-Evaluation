                                ...
                                <div class="card-box">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <c:forEach var="ouvrage" items="${ouvrage}">
                                                <tr>
                                                    <td> ${ouvrage.type}</td>
                                                    <td> ${ouvrage.getTitre()}   </td>
                                                    <td> ${ouvrage.getAuteurs()} </td>
                                                    <td> ${ouvrage.getMaison()}  </td>
                                                    <td> ${ouvrage.getAnnee()}   </td>
                                                    <td> ${ouvrage.getNb_pages()}</td>



                                                    <td><a onclick="alert('activité supprimée !')" href="/Enseignant/Ouvrage/Supp/${ensId}/${ouvrage.id_ouv}" style="color:red;"><u>              Supprimer</u></a></td>
                                                    <td><a  class="apg" href="/Enseignant/Ouvrage/Update/${ensId}/${ouvrage.id_ouv}" data-toggle="modal" data-target="#modal2" style="color:blue;"><u>             Modifier</u></a></td>
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                ...
                                                                <div class="modal-content" style="padding:0px;">
                                                                    ...
                                                                    <div class="modal-body" style="padding: 10px;">
                                                                        ...
                                                                        <form id="infoOP" action="/Enseignant/Ouvrage/Update/${ensId}/${ouvrage.id_ouv}" method="post" >

                                                                            <br/>
                                                                            <label>Type de Document</label>
                                                                            <select class="form-control" name="type" value="${ouvrage.type}">
                                                                            ...
                                                                            <br/>
                                                                            <label>Titre</label>
                                                                            <input value="${ouvrage.titre}" name="titre" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label>Auteurs</label>
                                                                            <input  value="${ouvrage.auteurs}" name="auteurs" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Année d'édition</label>
                                                                            <input  value="${ouvrage.annee}" name="anneeE" type="number" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Nombre de pages</label>
                                                                            <input value="${ouvrage.nb_pages}" name="nb_pages" type="number" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label>Maison d'édition</label>
                                                                            <input  value="${ouvrage.maison}" name="maison" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <div class="modal-footer" style="padding: 10px;">
                                                                                <input onclick="alert('activité modifiée !')" type="submit" id="okOP" class="btn btn-info btn-md" aria-hidden="true" value="Enregistrer"/>
