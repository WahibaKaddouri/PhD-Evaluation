                                        ...
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <c:forEach var="publication" items="${publication}">
                                                <tr>
                                                    ...
                                                    <td> ${publication.position_auteur} </td>
                                                    <td> ${publication.titre_revue}  </td>
                                                    <td> ${publication.type}  </td>
                                                    <td> ${publication.annee}   </td>
                                                    <td> ${publication.url}</td>

                                                    <td><a onclick="alert('activité supprimée !')" href="/Enseignant/Publication/Supp/${ensId}/${publication.id_pub}" style="color:red;"><u>              Supprimer</u></a></td>
                                                    <td><a  class="apg" href="/Enseignant/Publication/Update/${ensId}/${publication.id_pub}" data-toggle="modal" data-target="#modal4" style="color:blue;"><u>             Modifier</u></a></td>
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                ...
                                                                <div class="modal-content" style="padding:0px;">
                                                                    ...
                                                                    <div class="modal-body" style="padding: 10px;">
                                                                        ...
                                                                        <form id="infoPS" action="/Enseignant/Publication/Update/${ensId}/${publication.id_pub}" method="post" >

                                                                            <br/>
                                                                            <label>Type publication</label>
                                                                            <select class="form-control" name="type" value="${publication.type}">
                                                                                <option value="nationale">nationale</option>
                                                                                <option value="internationale">internationale</option>
                                                                            </select>
                                                                            <br/>
                                                                            <label>Titre de l'article</label>
                                                                            <input value="${publication.titre_article}" name="titre_article" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label>Position de l'auteur</label>
                                                                            <input value="${publication.position_auteur}" name="position_auteur" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Titre de la revue/journal</label>
                                                                            <input value="${publication.titre_revue}" name="titre_revue" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Année</label>
                                                                            <input value="${publication.annee}" name="annee" type="number" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Adresse URL </label>
                                                                            <input value="${publication.url}" name="url" type="url" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>

                                                                            <div class="modal-footer" style="padding: 10px;">
                                                                                <input onclick="alert('activité modifiée !')" type="submit" id="okEP" class="btn btn-info btn-md" aria-hidden="true" value="Enregistrer"/>
