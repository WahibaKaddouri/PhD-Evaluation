...
<head>
    ...
    <title>Grille: Responsabilités</title>
...
<div style="position:relative">
    <div style="width:600px;">
        <div class="grid-header" style="width:100%">
            <label>Responsabilités Administratives</label>
...
<script>
    ...
    var d1 = {"id": "1", "nom":"D-1 Responsabilités administratives (Recteur, vice-recteur, doyen ...)", "formule":"3 pts",
        "bareme":"3", "info_supp": "0", "pointSousVar": "0"};
    var d2 = {"id": "2", "nom":"D-2 Présidence d'organes d'évaluation pédagogique et scientifique ", "formule":"2 pts",
            ...
            $("form").submit(
                function() {
                    ...
                    $.ajax({
                        type : 'POST',
                        contentType: "application/json; charset=utf-8",
                        url : '/CUN/Evaluation/ResponsabilitesAdministratives/${ens.getId()}',
                        dataType : "json",
                        data : JSON.stringify(data),
                        success : function(data) {
                            console.log("SUCCESS");
