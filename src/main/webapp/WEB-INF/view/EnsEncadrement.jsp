                                        ...
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <c:forEach var="encadrement" items="${encadrement}">
                                                <tr>
                                                    ...
                                                    <td><a onclick="alert('activité supprimée !')" href="/Enseignant/Encadrements/Supp/${ensId}/${encadrement.getId_enc()}" style="color:red;"><u>              Supprimer</u></a></td>
                                                    <td><a  class="apg" href="/Enseignant/Encadrement/Update/${ensId}/${encadrement.id_enc}" data-toggle="modal" data-target="#modal3" style="color:blue;"><u>             Modifier</u></a></td>
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                ...
                                                                <div class="modal-content" style="padding:0px;">
                                                                    ...
                                                                    <div class="modal-body" style="padding: 10px;">
                                                                        ...
                                                                        <form id="infoEP" action="/Enseignant/Encadrement/Update/${ensId}/${encadrement.id_enc}" method="post" >

                                                                            <br/>
                                                                            <label>Type Encadrement</label>
                                                                            <select class="form-control" name="type" value="${encadrement.type}">
                                                                            ...
                                                                            <input value="${encadrement.candidat}" name="candidat" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label>Titre du mémoire</label>
                                                                            <input value="${encadrement.titre}" name="titre" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Date de soutenance</label>
                                                                            <input  value="${encadrement.date_soutenance}" name="date_soutenance" type="date" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>

                                                                            <div class="modal-footer" style="padding: 10px;">
                                                                                <input onclick="alert('activité modifiée !')" type="submit" id="okPS" class="btn btn-info btn-md" aria-hidden="true" value="Enregistrer"/>
