            ...
            <div class="scrollbar-wrapper">
                <div>
                    ...
                    <ul class="metisMenu nav" id="side-menu">
                        ...
                        <li><a href="/CUN/FicheCandidature/${enseign.id}"><i class="fa fa-file"></i> Fiche de candidature </a></li>

                        <li><a href="/CUN/dossierADM/${enseign.id}"><i class="fa fa-file"></i> Dossier administratif </a></li>

                        <li><a href="/CUN/dossierPED/${enseign.id}"><i class="fa fa-file"></i> Dossier pédagogique</a></li>
                        <li><a href="/CUN/AffObsCUN/${enseign.id}"><i class="fa fa-file"></i> Observations de la tutelle administrative</a></li>
        ...
        <div id="page-right-content">
            ...
            <div>
                ...
                <c:if test="${EtatD=='Dossier soumis'}">
                    <div class="container">
                        <div class="jumbotron">
                            <h3>le dossier du candidat a été soumis</h3>
                ...
                <c:if test="${EtatD!='Dossier soumis'}">
                    <div class="container">
                        <div class="jumbotron">
                            <h3>le dossier du candidat n'a pas encore été soumis</h3>
