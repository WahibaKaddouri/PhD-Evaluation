        ...
        <div class="navbar navbar-default" role="navigation" style="background-color: #067790">
            <div class="container">
                <div class="">
                    ...
                    <!-- Top nav left menu -->
                    <ul class="navbar-nav hidden-sm hidden-xs top-navbar-items" style="margin-top:-20px;">
                    ...
                    <div class="tab-content" style="height:100%">
                        <div class="row" align="center">
                          <div style="margin-left:20%;margin-top: 30px;">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="width:40%">
                                <div class="highlight-block xs-margin margin-bottom-20">
                                    <div class="highlight-block-inner height350">
                                        ...
                                        <h5 class="clear" style="text-align: center; color: #067790;">Dossier administratif</h5>
                                        <p style="text-align: center;">Renseigner les informations de mon dossier administratif</p><br>
                                        <a  class="fa fa-arrow-right" href="/Enseignant/Dossier_administratif"> </a>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="width:40%">
                                <div class="highlight-block xs-margin margin-bottom-20">
                                    <div class="highlight-block-inner height350">
                                        <i class="fa fa-book" aria-hidden="true" style=""></i>
                                        <h5 class="clear" style="text-align: center; color: #067790;">Dossier Pédagogique</h5>
                                        <p style="text-align: center;">Renseigner les informations de mon dossier pédagogique</p><br>
                                        <a  class="fa fa-arrow-right" href="/Enseignant/Dossier_pédagogique"> </a>
                                    </div> <!--  end .main_highlights  -->
                                </div> <!--  end .main_highlights  -->
                            </div>
