            ...
            <div class="container">
                ...
                <div class="m-t-30">
                    <ul class="nav nav-tabs tabs-bordered" style="margin-top:200px;height: 30px;padding-bottom:38px;">
                        <li class="active">
                            <a id="hb1"  href="/Enseignant/dossiers2" data-toggle="" aria-expanded="true" style="height:38px;border-radius: 0px;">
                                Constituer mon dossier
                            </a>
                        </li>
                        <li class="" style="height:40px;">
                            <a id="pb1" href="/Enseignant/SoumettreDossier" data-toggle="" aria-expanded="false" style="height:38px;border-radius: 0px;">
                                Soumettre mon dossier
                            </a>
                        </li>
                        <li class="">
                            <a id="pb2"  href="/Enseignant/EtatDossier" data-toggle="" aria-expanded="false" style="height:38px;border-radius: 0px;">
                                Etat de mon dossier
                            </a>
                        </li>
                        <li class="">
                            <a id="pb3" href="/Enseignant/Profil" data-toggle="" aria-expanded="false" style="height:38px;border-radius: 0px;">
                                Profile
                            </a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" style="height:100%">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0" style=" text-align: center;">Les animations scientifiques</h4>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <c:forEach var="animation" items="${animation}">
                                                <tr>
                                                    ...
                                                    <td> ${animation.lieu}  </td>
                                                    <td> ${animation.date}  </td>
                                                    <td> ${animation.qualite} </td>
                                                    <td><a onclick="alert('activité supprimée !')" href="/Enseignant/Animation/Supp/${ensId}/${animation.id_anim}" style="color:red;"><u>              Supprimer</u></a></td>
                                                    <td><a  class="apg" href="/Enseignant/Animation/Update/${ensId}/${animation.id_anim}" data-toggle="modal" data-target="#modal7" style="color:blue;"><u>             Modifier</u></a></td>
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                ...
                                                                <div class="modal-content" style="padding:0px;">
                                                                    ...
                                                                    <div class="modal-body" style="padding: 10px;">
                                                                        <form id="infoAS" action="/Enseignant/Animation/Update/${ensId}/${animation.id_anim}" method="post" >

                                                                            <br/>
                                                                            <label>Type animation</label>
                                                                            <select value="${animation.type}" class="form-control" name="type">
                                                                            ...
                                                                            <input value="${animation.lieu}" name="lieu" type="text" class="form-control" data-placement="top" data-trigger="manual"/>

                                                                            <br/>
                                                                            <label>Date</label>
                                                                            <input value="${animation.date}" name="date" type="date" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>

                                                                            <label >Qualité</label>
                                                                            <select value="${animation.qualite}" class="form-control" name="qualite">
                                                                                <option value="organisateur">organisateur</option>
                                                                                <option value="comite sceintifique">comite scientifique</option>
                                                                            ...
                                                                            <div class="modal-footer" style="padding: 10px;">
                                                                                <input onclick="alert('activité modifiée !')" type="submit" id="okAS" class="btn btn-info btn-md" aria-hidden="true" value="Enregistrer"/>
