                    ...
                    <div class="tab-content" style="height:100%">
                        <div class="row" style="padding-right:100px;padding-left:100px;">
                            <div class="timeline timeline-left">
                                <c:if test="${EtatD!='Dossier soumis'}">
                                <article class="timeline-item alt">
                                    <div class="text-left">
                                        <div class="time-show first">
                                            <a href="#" class="btn btn-custom">Etat de mon dossier</a>
                                        </div>
                                    </div>
                                </article>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="timeline-box">
                                                ...
                                                <h4 class="text-success">Constitution du dossier</h4>
                                                <p class="timeline-date text-muted"><small style="color:red;">incomplet</small></p>
                                                <p></a>Votre dossier est incomplet, veuillez renseigner les informations nécéssaires</p>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="timeline-box">
                                                ...
                                                <h4 class="">Soumission du dossier</h4>
                                                <p class="timeline-date text-muted"><small>veuillez vérifier que votre dossier est complet avant de l'envoyer pour évaluation</small></p>
                                                <p></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="timeline-box">
                                                <span class="arrow"></span>
                                                <span class="timeline-icon"><i class="mdi mdi-checkbox-blank-circle-outline"></i></span>
                                                <h4 class="">Suivi de mon dossier</h4>
                                                <p class="timeline-date text-muted"><small>Revenez ici pour voir les réponses de l'administration et de la commission universitaire suite à la récéption de votre dossier</small></p>
                                                <p></p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <h4 class="text-success">Constitution du dossier</h4>
                                                    <p class="timeline-date text-muted"><small>incomplet</small></p>
                                                    <p></a>Votre dossier est incomplet, veuillez renseigner les informations nécéssaires</p>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="timeline-box">
                                                    ...
                                                    <span class="timeline-icon "><i class="mdi mdi-checkbox-blank-circle-outline"></i></span>
                                                    <h4 class="">Soumission du dossier</h4>
                                                    <p class="timeline-date text-muted"><small>Votre dossier a été bien soumis pour évaluation !</small></p>
                                                    <p></p>
                                                </div>
                                            </div>
                                        </div>
