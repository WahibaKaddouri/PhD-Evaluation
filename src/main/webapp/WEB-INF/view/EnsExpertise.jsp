            ...
            <div class="container">
                ...
                <div class="m-t-30">
                    ...
                    <div class="tab-content" style="height:100%">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0" style=" text-align: center;">Expertise</h4>
                            </div>
                        </div>
                                ...
                                <div class="card-box">
                                    <div class="table-responsive">
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <tr>
                                                <th>Description du contexte de l'expertise</th>
                                            ...
                                            <tbody id="idTabele">
                                            <c:forEach var="expertise" items="${expertise}">
                                                <tr>
                                                    <td> ${expertise.contexte}   </td>
                                                    <td> ${expertise.organisme}  </td>
                                                    <td> ${expertise.annee}  </td>

                                                    <td><a onclick="alert('activité supprimée !')" href="/Enseignant/Expertise/Supp/${ensId}/${expertise.id_exp}" style="color:red;"><u>              Supprimer</u></a></td>
                                                    <td><a  class="apg" href="/Enseignant/Expertise/Update/${ensId}/${expertise.id_exp}" data-toggle="modal" data-target="#modal8" style="color:blue;"><u>             Modifier</u></a></td>
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                ...
                                                                <div class="modal-content" style="padding:0px;">
                                                                    ...
                                                                    <div class="modal-body" style="padding: 10px;">
                                                                        <form id="infoEXP" action="/Enseignant/Expertise/Update/${ensId}/${expertise.id_exp}" method="post" >

                                                                            <br/>
                                                                            <label>Contexte de l'expertise</label>
                                                                            <input value="${expertise.contexte}" name="contexte" type="text" class="form-control" data-placement="top" data-trigger="manual"/>

                                                                            <br/>

                                                                            <label>Organisme demandeur</label>
                                                                            <input value="${expertise.organisme}" name="organisme" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>

                                                                            <label >Année</label>
                                                                            <input value="${expertise.annee}" name="annee" type="number" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>


                                                                            <div class="modal-footer" style="padding: 10px;">
                                                                                <input onclick="alert('activité modifiée !')" type="submit" id="okEXP" class="btn btn-info btn-md" aria-hidden="true" value="Enregistrer"/>
