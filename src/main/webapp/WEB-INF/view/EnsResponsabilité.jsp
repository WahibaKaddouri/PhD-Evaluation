            ...
            <div class="container">
                ...
                <div class="m-t-30">
                    ...
                    <div class="tab-content" style="height:100%">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0" style=" text-align: center;">Responsabilité</h4>
                            </div>
                        </div>
                                ...
                                <div class="card-box">
                                    <div class="table-responsive">
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <tbody id="idTabele">
                                            <c:forEach var="responsabilite" items="${responsabilite}">
                                                <tr>
                                                    <td> ${responsabilite.getType()}   </td>
                                                    <td> ${responsabilite.getAnnee_deb()}  </td>
                                                    <td> ${responsabilite.getAnnee_fin()}  </td>
                                                    <td> ${responsabilite. getStructure()}  </td>

                                                    <td><a onclick="alert('activité supprimée !')" href="/Enseignant/Responsabilite/Supp/${ensId}/${responsabilite.getId_resp()}" style="color:red;"><u>              Supprimer</u></a></td>
                                                    <td><a class="apg" href="/Enseignant/Responsabilite/Update/${ensId}/${responsabilite.getId_resp()}" data-toggle="modal" data-target="#modal9" style="color:blue;"><u>             Modifier</u></a></td>
                                                    <td>
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                ...
                                                                <div class="modal-content" style="padding:0px;">
                                                                    ...
                                                                    <div class="modal-body" style="padding: 10px;">
                                                                        <form id="infoRAS" action="/Enseignant/Responsabilite/Update/${ensId}/${responsabilite.getId_resp()}" method="post" >

                                                                            <br/>
                                                                            <label>Responsabilite</label>
                                                                            <select  value="${responsabilite.type}" class="form-control" name="type">
                                                                            ...
                                                                            <label>De</label>
                                                                            <input value="${responsabilite.annee_deb}" name="annee_deb" type="number" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>

                                                                            <label >A</label>
                                                                            <input value="${responsabilite.annee_fin}" name="annee_fin" type="number" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>

                                                                            <label >Structure(Faculte,Departement)</label>
                                                                            <input value="${responsabilite.structure}" name="structure" type="texte" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>


                                                                            <div class="modal-footer" style="padding: 10px;">
                                                                                <input onclick="alert('activité modifiée !')"  type="submit" id="okRESP" class="btn btn-info btn-md" aria-hidden="true" value="Enregistrer"/>
