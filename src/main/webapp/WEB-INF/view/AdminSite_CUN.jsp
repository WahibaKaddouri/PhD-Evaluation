...
<div id="modal-wrapper" class="modal">
    ...
    <form class="modal-content animate" modelAttribute="userData" method="post" action="/AdminSite/CUN">
        <div>
        <span onclick="document.getElementById('modal-wrapper').style.display='none'" class="close" title="Close PopUp">&times;</span>
        </div>
        <div class="container">
            <input style="margin-top:30px "type="text" placeholder="Enter Username" name="username">
            <input type="password" placeholder="Enter Password" name="password">
            <button type="submit" value="register">Créer membre CUN</button>
        </div>
        ...
        <div id="page-right-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">liste des membres de la commission </h3>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <c:if test="${ !empty usersCUN}">
                                        <c:forEach var="l" items="${usersCUN}">
