                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mails m-0 table table-actions-bar">
                                    ...
                                    <c:forEach var="l" items="${variables}">
                                        <tr>
                                            <td><c:out value="${ens.id}"></c:out></td>
                                            <td><c:out value="${ens.nom}"></c:out></td>
                                            <td><c:out value="${ens.prenom}"></c:out></td>
                                            <td><c:out value="${ens.id_etablissement}"></c:out></td>

                                            <td>
                                                <a href="/CUN/Evaluation/${l.nom}/${ens.id}" class="btn btn-default btn-sm btn-icon icon-left" >
                                                        ${l.nom}
