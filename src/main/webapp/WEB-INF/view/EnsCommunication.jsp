            ...
            <div class="container">
                ...
                <div class="m-t-30">
                    ...
                    <div class="tab-content" style="height:100%">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="header-title m-t-0" style=" text-align: center;">Communication</h4>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover mails m-0 table table-actions-bar">
                                            ...
                                            <tr>
                                                ...
                                                <th>Titre  de la revueou nom du journal</th>
                                                <th>Année</th>
                                                <th>Type</th>
                                                <th>URL </th>
                                            ...
                                            <c:forEach var="communication" items="${communication}">
                                                <tr>
                                                    <td> ${communication.getTitre_com()}   </td>
                                                    ...
                                                    <td><a onclick="alert('activité supprimée !')" href="/Enseignant/Communications/Supp/${ensId}/${communication.getId_com()}" style="color:red;"><u>              Supprimer</u></a></td>
                                                    <td><a  class="apg" href="/Enseignant/Communication/Update/${ensId}/${communication.id_com}" data-toggle="modal" data-target="#modal5" style="color:blue;"><u>             Modifier</u></a>
                                                            ...
                                                            <div class="modal-dialog modal-sm">
                                                                ...
                                                                <div class="modal-content" style="padding:0px;">
                                                                    ...
                                                                    <div class="modal-body" style="padding: 10px;">
                                                                        <form id="infoCS" action="/Enseignant/Communication/Update/${ensId}/${communication.id_com}" method="post" >

                                                                            <br/>
                                                                            <label>Type communication</label>
                                                                            <select value="${communication.type}" class="form-control" name="type">
                                                                                <option value="nationale">nationale</option>
                                                                                <option value="internationale">internationale</option>
                                                                            </select>
                                                                            <br/>
                                                                            <label>Titre de la communication</label>
                                                                            <input value="${communication.titre_com}" name="titre_com" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label>Position de l'auteur</label>
                                                                            <input value="${communication.position_auteur}" name="position_auteur" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Titre de la manifestation</label>
                                                                            <input value="${communication.titre_manif}" name="titre_manif" type="text" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Année</label>
                                                                            <input value="${communication.annee}" name="annee" type="number" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>
                                                                            <label >Adresse URL </label>
                                                                            <input value="${communication.url}" name="url" type="url" class="form-control" data-placement="top" data-trigger="manual"/>
                                                                            <br/>

                                                                            <div class="modal-footer" style="padding: 10px;">
                                                                                <input onclick="alert('activité modifiée !')" type="submit" id="okCS" class="btn btn-info btn-md" aria-hidden="true" value="Enregistrer"/>
